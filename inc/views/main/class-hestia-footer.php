...
class Hestia_Footer extends Hestia_Abstract_Main {
	 ...
	 */
	private function render_custom_footer_sidebars() {
		if ( is_active_sidebar( 'custom-footer-widgets' ) ) : 
			dynamic_sidebar( 'custom-footer-widgets' ); 
		endif; 
	}
	...
	public function the_footer_content() {
		...
		<?php $this->render_custom_footer_sidebars(); ?>
