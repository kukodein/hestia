...
class Hestia_Woocommerce_Header_Manager extends Hestia_Abstract_Main {
	...
	public function woocommerce_page_header() {
		...
		if ( is_product_category() ) {
			$this->render_woocommerce_header_category();
		}
	...
	private function render_woocommerce_header_category() {

		$category = get_queried_object();

		$fields = get_fields("term_" . $category->term_id);
		...
		if ($fields != false) {
			...
			// echo $fields['product_category_test'];
			// echo "</div>";
		...
		<div class='category-product-content'>
			...
			<section class="category-product-content-item category-product-type-1">
				<div class="container-fluid g-0 position-relative">
					<img class="img-fluid" src="https://picsum.photos/seed/picsum/1080/300">
					<div class="position-absolute text-absolute-top-left"><h4 class="my-0">Top Left</h4></div>
					<div class="position-absolute text-absolute-top-center"><h4 class="my-0">Top Center</h4></div>
					<div class="position-absolute text-absolute-top-right"><h4 class="my-0">Top Right</h4></div>
					<div class="position-absolute text-absolute-left-center"><h4 class="my-0">Left Center</h4></div>
					<div class="position-absolute text-absolute-center-center"><h4 class="my-0">Center Center</h4></div>
					<div class="position-absolute text-absolute-right-center"><h4 class="my-0">Right Center</h4></div>
					<div class="position-absolute text-absolute-bottom-left"><h4 class="my-0">Bottom Left</h4></div>
					<div class="position-absolute text-absolute-bottom-center"><h4 class="my-0">Bottom Center</h4></div>
					<div class="position-absolute text-absolute-bottom-right"><h4 class="my-0">Bottom Right</h4></div>
				</div>
			</section>

			<section class="category-product-content-item category-product-type-2 bg-white">
				<div class="container-fluid g-0">
					<div class="kd-row m-0 align-items-center">
						<div class="kd-col-md-6 p-3 position-relative">
							<img class="img-fluid" src="https://picsum.photos/seed/picsum/400/300">
							<div class="position-absolute text-absolute-top-left"><h4 class="my-0">Top Left</h4></div>
							<div class="position-absolute text-absolute-top-center"><h4 class="my-0">Top Center</h4></div>
							<div class="position-absolute text-absolute-top-right"><h4 class="my-0">Top Right</h4></div>
							<div class="position-absolute text-absolute-left-center"><h4 class="my-0">Left Center</h4></div>
						...
						<div class="kd-col-md-6 p-3 px-5 py-2">
			...
			<section class="category-product-content-item category-product-type-3 bg-white">
				<div class="container-fluid g-0">
					<div class="kd-row m-0 align-items-center">
						<div class="kd-col-md-6 p-3 px-5 py-2 order-md-1 order-2">
							<h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h4>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
						</div>
						<div class="kd-col-md-6 p-3 order-md-2 order-1 position-relative">
							<img class="img-fluid" src="https://picsum.photos/seed/picsum/400/300">
							<div class="position-absolute text-absolute-top-left"><h4 class="my-0">Top Left</h4></div>
							<div class="position-absolute text-absolute-top-center"><h4 class="my-0">Top Center</h4></div>
							<div class="position-absolute text-absolute-top-right"><h4 class="my-0">Top Right</h4></div>
